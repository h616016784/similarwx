package com.android.similarwx.config;
...
public class NimSDKOptionConfig {
    ...
    public static SDKOptions getSDKOptions(Context context) {
        ...
        // 通知栏显示用户昵称和头像
        options.userInfoProvider = new NimUserInfoProvider(AppContext.getContext());
    ...
    static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + AppContext.getContext().getPackageName();
        }
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 点击通知需要跳转到的界面
        config.notificationEntrance = MainChartrActivity.class;
        config.notificationSmallIconId = R.mipmap.logal;
        config.notificationColor = AppContext.getContext().getResources().getColor(R.color.colorPrimary);
        // 通知铃声的uri字符串

...
public class UserPreferences {
    ...
    static SharedPreferences getSharedPreferences() {
        return AppContext.getContext().getSharedPreferences("Demo." + SharePreferenceUtil.getString(AppContext.getContext(), AppConstants.USER_ACCID,""), Context.MODE_PRIVATE);
    }
}

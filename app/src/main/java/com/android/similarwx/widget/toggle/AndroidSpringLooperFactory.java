...
package com.android.similarwx.widget.toggle;
...
abstract class AndroidSpringLooperFactory {
  ...
  /**
   * Create an Android {@link com.pisgah.membo.posc.togglebutton.util.SpringLooper} for the detected Android platform.

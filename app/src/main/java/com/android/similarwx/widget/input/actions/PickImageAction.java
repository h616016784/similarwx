...
public abstract class PickImageAction extends BaseAction {
    ...
    @Override
    public void onClick() {
        int requestCode = makeRequestCode(AppConstants.PICK_IMAGE);
    ...
    private void onPickImageActivityResult(int requestCode, Intent data) {
        ...
        if (local) {
            ...
            getActivity().startActivityForResult(intent, makeRequestCode(AppConstants.PREVIEW_IMAGE_FROM_CAMERA));
        }
    }
    ...
    private void onPreviewImageActivityResult(int requestCode, Intent data) {
        if (data.getBooleanExtra(PreviewImageFromCameraActivity.RESULT_SEND, false)) {
            ...
            if (requestCode == AppConstants.PREVIEW_IMAGE_FROM_CAMERA) {
                PickImageActivity.start(getActivity(), makeRequestCode(AppConstants.PICK_IMAGE), PickImageActivity.FROM_CAMERA, path);
            }
        }
    }
}

package com.android.similarwx.misdk.activity;
...
import com.android.similarwx.misdk.PickerUtil;
import com.android.similarwx.misdk.RequestCode;
import com.android.similarwx.misdk.adapter.PickerPreviewPagerAdapter;
import com.android.similarwx.misdk.model.PhotoInfo;
import com.android.similarwx.misdk.model.PickerContract;
import com.android.similarwx.widget.imageview.BaseZoomableImageView;
...
public class PickerAlbumPreviewActivity extends UI implements OnClickListener, OnPageChangeListener {
    ...
    public static void start(Activity activity, List<PhotoInfo> photos, int position, boolean supportOrig,
        ...
        activity.startActivityForResult(intent, AppConstants.PICKER_IMAGE_PREVIEW);
    }
    ...
    public static void start(Fragment fragment, List<PhotoInfo> photos, int position, boolean supportOrig,
        ...
        intent.putExtra(Extras.EXTRA_IS_ORIGINAL, isOrig);
        intent.putExtra(Extras.EXTRA_MUTI_SELECT_SIZE_LIMIT, mutiSelectLimitSize);
        fragment.startActivityForResult(intent, AppConstants.PICKER_IMAGE_PREVIEW);
    }

...
import com.android.similarwx.misdk.adapter.ImagePagerAdapterInImageSwitch;
...
public class PreviewImageFromLocalActivity extends UI {
    ...
    protected void choosePictureFromLocal() {
        ...
        new AsyncTask<String, Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                ...
                PickImageActivity.start(thiz, AppConstants.GET_LOCAL_IMAGE, from, "");
            }
        }.execute();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            if (requestCode == AppConstants.GET_LOCAL_IMAGE) {

package com.android.similarwx.misdk.helper;
...
//                sb.append(TeamHelper.getTeamMemberDisplayNameYou(tid, account) + " 修改了群公告");
                ...
                if (type == VerifyTypeEnum.Free) {
                    sb.append(authen + AppContext.getContext().getString(R.string.team_allow_anyone_join));
                } else if (type == VerifyTypeEnum.Apply) {
                    sb.append(authen + AppContext.getContext().getString(R.string.team_need_authentication));
                } else {
                    sb.append(authen + AppContext.getContext().getString(R.string.team_not_allow_anyone_join));
                }

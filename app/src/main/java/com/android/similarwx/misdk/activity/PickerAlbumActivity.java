...
import com.android.similarwx.misdk.fragment.PickerAlbumFragment;
import com.android.similarwx.misdk.fragment.PickerImageFragment;
import com.android.similarwx.misdk.model.AlbumInfo;
...
public class PickerAlbumActivity extends UI implements PickerAlbumFragment.OnAlbumItemClickListener,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == AppConstants.PICKER_IMAGE_PREVIEW) {

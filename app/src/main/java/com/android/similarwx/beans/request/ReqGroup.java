package com.android.similarwx.beans.request;
...
public class ReqGroup {
    ...
    private String totalRedEnvelopes;
    private String px;
    ...
    public String getTotalRedEnvelopes() {
        return totalRedEnvelopes;
    }

    public void setTotalRedEnvelopes(String totalRedEnvelopes) {
